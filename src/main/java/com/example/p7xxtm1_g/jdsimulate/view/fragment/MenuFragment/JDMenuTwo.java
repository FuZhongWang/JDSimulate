...
public class JDMenuTwo extends Fragment {
    private ArrayList<MenuBean.DataBean> list = new ArrayList<>();
    private RecyclerView jd_menu_two_item;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View inflate = inflater.inflate(R.layout.jd_menu_two, container, false);
        jd_menu_two_item = inflate.findViewById(R.id.jd_menu_two_item);
        return inflate;
    }
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        jd_menu_two_item.setLayoutManager(gridLayoutManager);
        jd_menu_two_item.setAdapter(menRecyClerViewAdapter);
